...
namespace CStat.Models
{
    ...
    {
        public enum EType { Unknown = 0, NYS = 1, USGov, Propane, Electric, Phone, Internet, Refuse, Rentals, Hardware, Accounting, Bank_CC, Food, Water, Septic, Kitchen_Supply, Department, Office_Supply, Inspection, Insurance, Water_Test, Law, Recreation, Ministry, Auto_Repair, Tires_Repair, Town }
