...
namespace CStat.Models
{
    ...
    public partial class Task
    {
        public enum eTaskType
        {
            ...
            At_End          = 0x00000004 << 26,
            Before_End      = 0x00000005 << 26,
            After_End       = 0x00000006 << 26,
            At_Hour         = 0x00000007 << 26,
            Before_Hour     = 0x00000008 << 26,
            On_Day          = 0x00000009 << 26,
            Before_Day      = 0x0000000A << 26,
            On_Week_Day     = 0x0000000B << 26,
            Before_Week_Day = 0x0000000C << 26,
            On_Week         = 0x0000000D << 26,
