...
namespace CStat.Models
{
    ...
    public partial class Task
    {
        public enum eTaskType
        {
            ...
            At_Hour         = 0x00000004 << 26,
            Before_Hour     = 0x00000005 << 26,
            By_Hour         = 0x00000006 << 26,
            At_Day          = 0x00000007 << 26,
            Before_Day      = 0x00000008 << 26,
            By_Day          = 0x00000009 << 26,
            At_Week_Day     = 0x0000000A << 26,
            Before_Week_Day = 0x0000000B << 26,
            By_Week_Day     = 0x0000000C << 26,
            At_Week         = 0x0000000D << 26,
            Before_Week     = 0x0000000E << 26,
            By_Week         = 0x0000000F << 26,
            At_Month        = 0x00000010 << 26,
            Before_Month    = 0x00000011 << 26,
