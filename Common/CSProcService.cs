                ...
                try
                {
...
#endif
                    {
                        ...
                        using (var ptz = new PtzCamera())
                        {
                            ...
                            ptz.EnableEMailAlerts(!Event.IsEventDay(_context, -8, 6)); // disable camera email alerts starting 8 hours of the first day of the event up to 6 pm on the last day
                        }
